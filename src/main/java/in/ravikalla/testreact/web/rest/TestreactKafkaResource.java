...
import in.ravikalla.testreact.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/testreact-kafka")
public class TestreactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestreactKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TestreactKafkaResource(KafkaProperties kafkaProperties) {
